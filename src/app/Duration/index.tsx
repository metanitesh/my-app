...
export default function App() {
      ...
      >
        ...
        >
          <View style={styles.touchableContainer}>
            <Text className="text-[48px] text-[#F1F1F1]">
              {alarmStringExample1}
            </Text>
            ...
            >
              <View style={styles.buttonContainer}>
                <Text style={[styles.button, styles.buttonDark]}>
                  Set Alarm 🔔
                </Text>
              </View>
            </TouchableOpacity>
  ...
  }, [alarmStringExample1, screenWidth, showPickerExample1, pickerFeedback]);
      ...
      >
        ...
        >
          <View style={styles.touchableContainer}>
            ...
            >
              <View style={styles.buttonContainer}>
                <Text style={[styles.button, styles.buttonLight]}>
                  Set Alarm 🔔
                </Text>
              </View>
            </TouchableOpacity>
  ...
  }, [alarmStringExample2, screenWidth, showPickerExample2, pickerFeedback]);
